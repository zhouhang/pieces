package com.jointown.zy.common.appender;
...
public class JointownSyslogAppender extends JointownSyslogAppenderBase<ILoggingEvent>{
	    ...
	    while (tp != null) {
	      ...
	      try {
	        ...
	        for (StackTraceElementProxy step : stepArray) {
	          ...
	          sw.write(sb.toString().getBytes("UTF-8"));
	          sw.flush();
	        }
	      } catch (IOException e) {
	        break;
