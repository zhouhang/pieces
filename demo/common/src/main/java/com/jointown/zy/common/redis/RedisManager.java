...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	/**
	 * 显式指定redis enum来定义byte[] key
	 * @param key
	 * @param redisEnum
	 * @return
	 */
	public byte[] getByteKey(Serializable key,RedisEnum redisEnum){
		return getStringKey(key, redisEnum).getBytes();
	}
	
	/**
	 * 显式指定redis enum来定义String key
	 * @param key
	 * @param redisEnum
	 * @return
	 */
	public String getStringKey(Serializable key,RedisEnum redisEnum){
		return redisEnum.getValue(key.toString()) + key;
	}
