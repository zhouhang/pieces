...
public class EncryptUtil
{
	 ...
	 */
	public static Password JointownEncode(String plainPassword){
		String random=RandomStringUtils.randomAlphanumeric(32);
		return JointownEncode(plainPassword,random);
	}
	 ...
	 * @return Password class which contains salted password and salt.
	 */
    public static Password JointownEncode(String plainPassword,String salt,String... encodes){
...
//    public static void main(String[] args) throws UnsupportedEncodingException {
		//System.out.println(getSHA1("123456", "UTF-8"));
//		System.out.println(URLEncoder.encode(base64Encode("{\"user_name\":\"2359310491\",\"external_id\":8,\"phone\":\"ucloud测试\",\"company\":\"ucloud测试\",\"user_id\":5507,\"user_email\":\"235931049@qq.com\"}", "utf-8")));
//		System.out.println(base64Decode("", "UTF-8"));
//		Password p = JointownEncode("password");
//		System.out.println(p.getPlainPassword());
