...
import com.jointown.zy.common.util.Num62;
...
* 类描述：  按日期随机生成文件名
* 创建人：Mr.songwei  
* 创建时间：2014-12-4 下午12:15:18  
* 修改人：  
* 修改时间：2014-12-4 下午12:15:18  
* 修改备注：  
* @version   
*
 */
public class UploadUtils extends ImageUtils{
	/**
	 * 日期格式化对象
	 */
	public static final DateFormat YEAR_MONTH_DAY_FORMAT = new SimpleDateFormat(
			"/yyyyMM/ddHHmmss");
	...
	public static void main(String[] args) {
		System.out.println(generateFilename("gif"));
	}
