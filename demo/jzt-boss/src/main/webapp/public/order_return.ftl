...
<!-- pageCenter start -->
    <div class="main">
        <div class="page-main">
            <h1 class="title1">退款处理</h1>
            <form action="/depositFailed" method="post" id="queryForm">
                <ul class="form-search ac-search">
                    <li><span>订单编号：</span><input class="text text-4" type="text" name="orderId" value="${query.orderId!''}"/>&nbsp;
                        ...
                        <span>退款申请时间：</span><input class="text text-date" id="date_b" type="text" name="orderDateStart" value="${query.orderDateStart!''}"/> — <input class="text text-date" id="date_e" type="text" name="orderDateEnd" value="${query.orderDateEnd!''}"/>&nbsp;
            ...
            <div class="use-item1 mt20">
                <table class="table-1" width="100%" cellpadding="1" cellspacing="1">
                    <tr>
                        ...
                        <th width="10%" class="bgf5">退款申请时间</th>
                    		...
                    		<tr>
		                        ...
		                        <td>
		                        	...
		                        	<#elseif orderDeposit.depositState==4>
		                        		<@shiro.hasPermission name="退款处理-退款拒绝理由">
			                        	...
			                        	<@shiro.lacksPermission name="退款处理-退款拒绝理由">
		                        ...
		                        <td>
	                        		...
	                        		<a class="col_blue mr10" name="reDetail" href="javascript:;">退款详情</a>
			                        <#if orderDeposit.depositState == '1' || orderDeposit.depositState == '4'>
				                        <@shiro.hasPermission name="退款处理-退款"><a href="javascript:;" class="col_blue" name="account" data-orderid="${orderDeposit.orderId!''}" data-buyer="<@tools.money num=orderDeposit.buyerAmount format='0.##'/>" data-seller="<@tools.money num=orderDeposit.sellerAmount format='0.##'/>" data-total="<@tools.money num=orderDeposit.depositAmount format='0.##'/>" data-platform="<@tools.money num=orderDeposit.platformAmount format='0.##'/>">退款</a></@shiro.hasPermission>
			                        </#if>
		                        </td>
		                    </tr>
                    	</#list>
...
<div class="order-popup profit-box" datatype="losePay">
    <div class="close"></div>
        <h2 class="title">退款比例设置：</h2>
    <div id="Set">
        <form id="accountForm" action="/depositFailed/executeDeposit">
...
<script>
    $(function(){
        ...
        function getReject(obj){
    		...
    		$.ajax({
	    		type:"POST",
	    		url:"/depositFailed/applyDepositRejectList",
	    		data:{orderId:orderId,remitType:'3'},
	    		dataType:"json",
