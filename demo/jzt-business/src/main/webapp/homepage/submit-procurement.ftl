...
<div class="area-1200 clearfix">
    <div class="area-910 fl">
        <p class="title"><a href="/busiPurchaseApply/iWillProcurement" class="blue"><strong>+ 采购申请单</strong></a> </p>
        <div class="box-layout">
            <h2>采购申请单提交成功，我们将在一个工作日内给您答复<br/><span class="col_999 f16">全国业务电话：400-10-54315</span></h2>
            <p class="fl"><label class="col_999">姓名</label><span>${busiPurchaseApplyVo.applyName!''}</span></p>
            <p class="fr"><label class="col_999">手机</label><span>${busiPurchaseApplyVo.applyMobile!''}</span></p>
            <div class="clearfix"></div>
            <h3 class="col_999">采购药材数量及产地</h3>
            <table cellpadding="0" cellspacing="0" width="718"  class="table1" id="tb">
                <tr bgcolor="f5e4c1">
                    <th width="110" height="38">药材名称</th>
                    <th width="90">等级规格</th>
                    <th width="90">数量</th>
                    <th width="90">价格</th>
                    <th width="90">产地</th>
                ...
                <#if busiPurchaseApplyVo??>
                	<#list busiPurchaseApplyVo.busiPurchaseApplies as busiPurchaseApply>
		                <tr datatype="mes" class="t-in10">
		                    <td height="50">${busiPurchaseApply.breedName!''}</td>
		                    <td>${busiPurchaseApply.breedStandardLevel!''}</td>
		                    <td>${busiPurchaseApply.breedAmount!''}</td>
		                    <td>${busiPurchaseApply.breedPrice!''}</td>
		                    <td>${busiPurchaseApply.breedPlace!''}</td>
		                    <td>${busiPurchaseApply.breedDesc!''}</td>
		                </tr>
                	</#list>
                </#if>
            </table>
