...
//$(function(){
		...
		function beforeDrop(treeId, treeNodes, targetNode, moveType, isCopy) {
			if(targetNode.pId == dragId){  
             ...
             $.ajax({  
                  ...
                  type: "post",  
                  data:data,  
                  url:"getCategoryManage/updateCategoryOrder",  
	...
	/***************************************************右键菜单功能************************************************/
		...
		$("#addChildCategory").click(function(){
			...
			$("#addChildCatMsg").html("");
			$.post("getCategoryManage/validateCategoryName",{
							...
							if(date){
								...
								$.ajax({
									cache: true,
									type: "POST",
									url:"getCategoryManage/addTopCategory",
			...
			$.post("getCategoryManage/validateCategoryName",{
							...
							if(date){
								...
								$.ajax({
									cache: true,
									type: "POST",
									url:"getCategoryManage/updateCategory",
...
//});
    ...
    $("#cancleCatBtn").click(function(){
	 ...
	 $("#deleteCatBtn").click(function(){
        	...
        	var classId = $("#currentClassId").val();
        	$.post("getCategoryManage/validateCatChildrenOrhasBreed",{
        		"catId":catId,
				"classId":classId
      		},function(date){
        		if(date){
					...
					$.post("getCategoryManage/deleteCategory",{
						"classId":$("#currentClassId").val(),
						"catId":catId
						},function(date){
							if(date){
...
/************************************Tab分类*************************************/	
		...
		var $dialog = $( "#dialog" ).dialog({
			...
			//add by fanyuna
			$.post("getCategoryManage/validateClassbyName",{
        		...
        		if(date){
        			$.ajax({
						 type: "POST",
						 url: "getCategoryManage/addClassInfo",
		...
		$("#delClassBtn").click(function(){
        	...
        	$.post("getCategoryManage/validateClasshasCat",{
        		...
        		if(date){
					...
					$.post("getCategoryManage/deleteClass",{
						"classId":classId
						},function(date){
							if(date){
		...
		$("#updateClassBtn").click(function(){
        	...
        	$.post("getCategoryManage/validateClassbyName",{
        		...
        		if(date){
        			$.post("getCategoryManage/updateClassName",{
						"className":className,
						"classId":classId,
	...
	$("#classMsgBtn").click(function(){
		...
		if(isDelete){
			isDelete = false;
			window.location.replace("getCategoryManage");
