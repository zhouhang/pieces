...
<div class="area-1200 clearfix">
    ...
    <div class="hy-right fr">
        ...
        <div class="pickcard-box">
            ...
            <p class="fontstyle mt10"><strong>当前订单状态：</strong><span class="pr20">已取消</span><span class="col-red1"><#if order.orderCancelReasean=='6'>买方未付货款过期<#elseif order.orderCancelReasean=='8'>买方申请取消</#if></span></p>
...
<span>摘牌日期：${order.createtime?string('yyyy-MM-dd')}</span>&nbsp;&nbsp;卖方：${sellerName}</p>
            ...
            <table cellpadding="0" cellspacing="0" class="order-message mt20" width="100%">
              ...
              <div class="collect fr mt20">
			                ...
			                实际已付款：<strong><@tools.money num=order.actualPayment format="0.##"/></strong>元<br><br/>
                <#if order.remitPayment!=null>
             	   已退款：<strong><@tools.money num=order.remitPayment format="0.##"/></strong>元
                </#if>
            </div>
