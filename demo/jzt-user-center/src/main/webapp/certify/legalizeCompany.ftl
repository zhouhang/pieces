        ...
        <form id="legalizeCompany" method="post" action="/addCompanyCertify">
            <ul class="form-2 mt15">
                <li>	
                    ...
                    <input type="text" class="text-2 text-Valid" value="" name="companyName" ajaxurl="companyNameIsHaved" id="companyName" datatype="s4-60" nullmsg="请输入企业名称。" errormsg="请输入正确的企业名称4-60个字。">
                    <span class="Validform_checktip"></span>
                    <p class="capt">请填写真实企业名称，它也是在本站提现时使用的银行卡开户抬头，请谨慎！</p>
                </li>
                <li>
                    <label><i class="red">*</i>法定代表人：</label>
                    <input type="text" class="text-2 text-Valid" value="" name="presidentName" id="presidentName" datatype="zh2-10" nullmsg="请输入法人姓名。"  errormsg="请正确输入您正确的法人姓名（仅支持2-10个中文）。">
                    <span class="Validform_checktip"></span>
                    <p class="capt">法人姓名为2-10个中文！</p>
                </li>
                <li>
                    <label><i class="red">*</i>营业执照注册号：</label>
                    <input type="text" class="text-2 text-Valid" value="" name="licenceCode" id="licenceCode" datatype="*"  nullmsg="请输入营业执照上的注册号。" errormsg="请输入正确的营业执照注册号。" />
                    <span class="Validform_checktip"></span>
                    <p class="capt">请输入营业执照上的注册号！</p>
                </li>
                <li>
                    <label><i class="red">*</i>营业执照有效期：</label>
                    <input name="licenceStartdate" id="licenceStartdate" class="text-2 text-Valid" type="text" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'licenceEnddate\')}',dateFmt:'yyyy/MM/dd'})" style="width:174px; width:168px\9; *width:168px;" /> 至 <input name="licenceEnddate" id="licenceEnddate" class="text-2 text-Valid" type="text" datatype="vt" nullmsg="请输入有效日期。" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'licenceStartdate\')}',dateFmt:'yyyy/MM/dd'})" style="width:174px; width:168px\9; *width:168px;" />
                    <span class="Validform_checktip"></span>
                ...
                <li class="relative">
                    ...
                    <input type="hidden" id="hidFile" datatype="*"  nullmsg="请上传企业证件图。" value=""  />
                    <span class="Validform_checktip">图片支持jpg、gif、bmp、png格式，图片最大不要超过4MB <a href="http://help.54315.com/view-1209124341-1715159533.html"  class="col_red2" target="_blank">图片太大如何处理？</a></span>
                    ...
                    <i class="loading" id="loading">
                    	<img alt="" width="30" height="30" src="${RESOURCE_IMG}/images/loading.gif"/>
                    </i>
                </li>
                <li>
                    <label>组织机构代码：</label>
                    <input type="text" class="text-2 text-Valid" value="" name="orgCode" id="orgCode" />
                </li>	
                <li class="relative">
                    <label>上传企业证件：</label>
                    ...
                    <span class="col_999 ml10">图片支持jpg、gif、bmp、png格式，图片最大不要超过4MB</span>
                ...
                <li class="tj-btn"><input type="submit" id="subBtn" class="yellow-btn3" value="确认，提交" /></li>
