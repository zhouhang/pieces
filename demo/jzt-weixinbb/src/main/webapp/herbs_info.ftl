...
<div class="sell-box-head">
    <a href="/wxWhlist/wxWhlistManage" style="display:block;z-index:3;" class="relative"><i class="back"></i></a>
    <div align="center" class="inStore-title relative">药材信息</div>
</div>
...
<div class="sDetail-foot">
    <a class="yellow" href="/preview?img=${wxWhlist.zjReportPic}">查看质检报告单</a><a class="red2" href="/listing/wxWhlistManage">我要挂牌</a>
</div>
