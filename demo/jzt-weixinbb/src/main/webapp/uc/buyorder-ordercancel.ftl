...
<div class="orDe-box" style="padding-top:3.2em;" align="center">
    <div class="state1">
        <p class="sty1">当前订单状态：已取消
        </p>
        <span style="color:red;" ><#if order.orderCancelReasean=='6'>买方未付货款过期<#elseif order.orderCancelReasean=='8'>买方申请取消</#if></span>
    </div>
