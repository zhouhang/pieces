...
<div class="sell-box-head">
    <i class="back"></i>
    <div align="center" class="inStore-title">交易完成</div>
</div>
<div class="orDe-box">
    ...
    <div class="state">
        <p class="sty1">当前订单状态：买家已付款，交易完成。
        </p>
    </div>
            ...
            <dd>
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="right"><strong>￥<@tools.money num=(order.finalPayment) format="0.##"/></strong></td>
                    </tr>
                </table>
            </dd>
            <div class="clearfix"></div>
