 ...
 *
 */
public class BizCredentialsMatcher extends HashedCredentialsMatcher implements InitializingBean{
    ...
    public BizCredentialsMatcher(CacheManager cacheManager) {
    ...
    private boolean match(AuthenticationToken token, AuthenticationInfo info){
        ...
        if(token instanceof BizToken) {
            ...
            if (bizToken.getWechat()) return true;
        }
