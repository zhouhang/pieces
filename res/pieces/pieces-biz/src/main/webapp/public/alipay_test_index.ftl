...
<div class="header">
    <div class="container black">
        <div class="qrcode">
            <div class="littlecode">
                <img width="16px" src="images/little_qrcode.jpg" id="licode">
                <div class="showqrs" id="showqrs">
                    <div class="shtoparrow"></div>
                    <div class="guanzhuqr">
                        <img src="images/guanzhu_qrcode.png" width="80">
    ...
    <div class="container">
        <div class="nav">
            <a href="https://www.alipay.com/" class="logo"><img src="images/alipay_logo.png" height="30px"></a>
...
<div class="content">
    <form action="/pay/alipay/test" class="alipayform" method="POST" target="_blank">
