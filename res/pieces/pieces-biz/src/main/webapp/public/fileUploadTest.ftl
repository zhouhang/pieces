    ...
    <div class="wrap">
        <div class="side">
            ...
            <dl class="expand">
                ...
                <dd>
                    <a class="curr" href="user-info.html">注册资料</a>
                    <a href="user-update-password.html">修改密码</a>
                </dd>
            </dl>
        </div>
        ...
        <div class="main">
            ...
            <div class="fa-form">
                ...
                <div class="group">
                    ...
                    <div class="cnt">
                        <span class="val">18970700620</span>
                    </div>
                </div>
            </div>
        </div>
