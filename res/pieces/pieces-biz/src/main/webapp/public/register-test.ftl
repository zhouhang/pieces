            ...
            <div class="fa-form">
                <form action="" id="myform">
                    ...
                    <div class="group">
                        ...
                        <div class="cnt">
                            <input type="password" class="ipt" value="" autocomplete="off" name="pwd" id="pwd" placeholder="由数字、字母或下划线组成，长度为6-20">                            
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="cnt">
                            <input type="text" class="ipt" value="" autocomplete="off" name="companyName" id="companyName" placeholder="工商局注册的企业名称">                            
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="cnt">
                            <input type="text" class="ipt" value="" autocomplete="off" name="linkMan" id="linkMan" placeholder="企业联系人姓名">                            
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="cnt">
                            <input type="text" class="ipt" value="" autocomplete="off" name="mobile" id="mobile" placeholder="企业联系人的手机号码">                            
                        </div>
                    </div>
