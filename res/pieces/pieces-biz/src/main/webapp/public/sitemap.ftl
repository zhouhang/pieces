        ...
        <div class="wrap">
            <div class="sitemap">
                ...
                <dl>
                    ...
                    <dt>产品</dt>
                    <dd>                        
                        <a href="/commodity/index?categoryId=64">根茎类</a>
                        <a href="/commodity/index?categoryId=65">果实籽仁类</a>
                        <a href="/commodity/index?categoryId=68">花叶全草类</a>
