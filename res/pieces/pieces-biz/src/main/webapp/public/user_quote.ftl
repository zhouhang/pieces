...
<body>
    <section class="qoute">
        ...
        <#list vo.enquiryCommoditys as commodity>
            <div class="tr">
                ...
                <div class="td w5"><span>&yen; ${commodity.myPrice}</span></div>
            </div>
        </#list>
        </div>
        ...
        <div class="tips">
            ...
            <ul>
                <li>注册上工好药（www.sghaoyao.com）平台账号并登录；</li>
                <li>进入“用户中心”，在左侧菜单处点击“询价记录”；</li>
                <li>在右边询价记录中找到本次报价（询价单号：${vo.code}），点击“去下单”；</li>
                <li>勾选商品，点击“下单”按钮。</li>
            </ul>
        </div>
    </section>
