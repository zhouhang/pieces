                ...
                <div class="user-info">
                    ...
                    <div class="fa-form">
                        ...
                        <div class="group">
                            ...
                            <div class="cnt">
                                <input type="text" id="price" class="ipt" value="${(commodity.guidePrice?default(0))?string("0.00")}" name="guidePrice" autocomplete="off" placeholder="">
                            </div>
                        </div>
                        <div class="group">
                            <div class="txt">
                ...
                <div class="user-info">
                    ...
                    <div class="fa-form">
                        <div class="group">
                            ...
                            <div class="cnt cnt-mul">
                                <textarea  name="keyWord" id="keyWord" class="ipt ipt-mul">${commodity.keyWord!}</textarea>
                        ...
                        <div class="group">
                            ...
                            <div class="cnt cnt-mul">
                                <textarea  name="intro" id="intro"  class="ipt ipt-mul">${commodity.intro!}</textarea>
