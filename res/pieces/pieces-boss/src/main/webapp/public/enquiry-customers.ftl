    ...
    <div class="fa-floor">
        <div class="wrap">
            <div class="title title-btm">
                <h3>请选择客户</h3>
                <div class="extra"><a class="btn btn-gray" href="/enquiry/index">返回</a></div>
            </div>
            <div class="pagin">
                <div class="extra"> 
                ...
                <@p.pager pageInfo=customerPage  pageUrl="/enquiry/customer"  params=customerParams/>
            </div>
            <div class="chart">
                <table class="tc">
                    <thead>
            ...
            fn: {
                ...
                createEnquiry:function(){
                    $(".tc>tbody>tr").click(function(){
                        ...
                        location.href="/enquiry/create/"+customerId;
                    })
