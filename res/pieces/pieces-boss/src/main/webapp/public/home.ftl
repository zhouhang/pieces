...
<body>
    ...
    <div class="site-nav">
        <div class="wrap">
            <p class="fl">欢迎光临 上工好药饮片采购平台！</p>
            <ul class="fr">
                <li><a href="/to_login">登录</a> | <a href="">注册</a></li>
    ...
    <div class="footer">
        <div class="wrap">
            ...
            <div class="copyright">
                ...
                <p>网站商务合作邮箱：bd@copy;yaoyy.com  客户服务企业邮箱：service@copy;yaoyy.com  Copyright &copy; 2015 – 2020 上工好药 All Rights Reserved</p>
            </div>
        </div>
    </div><!-- footer end -->
