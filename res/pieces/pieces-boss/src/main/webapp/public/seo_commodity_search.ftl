        ...
        <div class="wrap">
            <div class="side">
                <dl>
                    ...
                    <dd>
                        ...
                        <a class="curr" href="/seo/setting/4">搜索结果页模板</a>
            ...
            <div class="main seo">
                <form type="POST" id="myform">
                    ...
                    <input type="hidden" class="ipt" name="type"  value="4">
                    <div class="title">
                        <h3><i class="fa fa-chevron-right"></i>搜索结果页模板</h3>
                        <div class="extra">
