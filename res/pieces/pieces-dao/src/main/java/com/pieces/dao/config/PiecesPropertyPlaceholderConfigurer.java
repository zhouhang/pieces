...
public class PiecesPropertyPlaceholderConfigurer extends
	...
	private static final String DEFAULT_PRE_CONFIG_LOCATION = "/com/pieces/dao/properties/preConfig.properties";
	private static final String DEFAULT_ENV_SUFFIX_KEY = "pieces.env";
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		try {
			...
			// 设置所有属性
			SpringConfigUtil.addConfigProperties(mergedProps);
