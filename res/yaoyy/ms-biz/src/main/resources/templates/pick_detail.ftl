    ...
    <div class="sinfo">
        ...
        <div class="item">
            ...
            <ul class="list">
                ...
                <li><a href="commodity/detail/${pickCommodityVo.id}"><em>${pickCommodityVo.name}</em><span>${pickCommodityVo.origin}  ${pickCommodityVo.spec}  ${pickCommodityVo.price}元/${pickCommodityVo.unit}</span></a><sub><em>${pickCommodityVo.total}</em> ${pickCommodityVo.unit} <b>&yen; <em>${pickCommodityVo.total}</em></b> 元</sub></li>
                </#list>
            </ul>
        </div>
